...
public class GsonRequest<T> extends Request<T> {
    ...
    public GsonRequest(int method, String url, Map<String, String> paraMap, Class<T> clazz, Listener<T> listener,
                       ErrorListener errorListener) {
        super(method, url, errorListener);
        mClass = clazz;
        mListener = listener;
    ...
    public GsonRequest(int method, String url, Map<String, String> paraMap, TypeToken<T> typeToken, Listener<T> listener,
                       ErrorListener errorListener) {
        super(method, url, errorListener);
        mTypeToken = typeToken;
        mListener = listener;
